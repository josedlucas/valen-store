        ...
        <div class="col-md-12">
            <div class="card border-0">
                <div class="card-header bg-transparent">
                    <h5 class="float-start">Agrupador de categorias</h5>
                    <router-link v-if="can('category-create')" :to="{ name: 'categorygroupers.create' }" class="btn btn-success btn-sm float-end">
                        Crear agrupador
                    </router-link>
                </div>
                ...
                <div class="card-footer">
                    <Pagination :data="categorygroupers" :limit="3"
                                @pagination-change-page="page => getCategoryGroupers(page, search_id, search_title, search_global, orderColumn, orderDirection)"
                                class="mt-4"/>
                </div>
            </div>
        </div>
...
<script setup>
    ...
    const {categorygroupers, getCategoryGroupers, deleteCategoryGrouper} = useCategoryGroupers()
