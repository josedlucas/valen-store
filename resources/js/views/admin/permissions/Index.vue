        ...
        <div class="col-md-12">
            <div class="card border-0">
                <div class="card-header bg-transparent">
                    ...
                    <router-link v-if="can('permission-create')" :to="{ name: 'permissions.create' }" class="btn btn-success btn-sm float-end">
                        Create Permission
                    </router-link>
                </div>
                            ...
                            <tr v-for="post in permissions.data" :key="post.id">
                                ...
                                <td class="px-6 py-4 text-sm">
                                    <router-link v-if="can('permission-edit')"
                                                 :to="{ name: 'permissions.edit', params: { id: post.id } }" class="badge bg-success">Editar
                                    </router-link>
