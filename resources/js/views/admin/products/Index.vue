        ...
        <div class="col-md-12">
            <div class="card border-0">
                ...
                <div class="card-footer">
                    <Pagination :data="products" :limit="3"
                                @pagination-change-page="page => getProducts(page, search_category, search_id, search_title, search_content, search_global, orderColumn, orderDirection)"
                                class="mt-4"/>
                </div>
            </div>
        </div>
