        ...
        <div class="col-md-12">
            <div class="card border-0">
                <div class="card-header bg-transparent">
                    <h5 class="float-start">Tallas</h5>
                    <router-link v-if="can('category-create')" :to="{ name: 'sizes.create' }" class="btn btn-success btn-sm float-end">
                        Crear talla
                    </router-link>
                </div>
                            ...
                            <tr v-for="size in sizes.data" :key="size.id">
                                ...
                                <td class="px-6 py-4 text-sm">
                                    <router-link v-if="can('category-edit')"
                                                 :to="{ name: 'sizes.edit', params: { id: size.id } }"
                                                 class="badge bg-success">Editar
                                    </router-link>
                                    <a href="#" v-if="can('category-delete')" @click.prevent="deleteSize(size.id)"
                ...
                <div class="card-footer">
                    <Pagination :data="sizes" :limit="3"
                                @pagination-change-page="page => getSizes(page, search_id, search_title, search_global, orderColumn, orderDirection)"
                                class="mt-4"/>
                </div>
            </div>
        </div>
...
const {sizes, getSizes, deleteSize} = useSizes()
